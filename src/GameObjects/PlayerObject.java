...
public class PlayerObject extends GameObject {
	...
	public PlayerObject() {
		...
		AddComponent(PlayerController.class, PlayerController.COMPONENT_NAME);
	...
	/**
	 * Constructor for player object where initial position and player size is predetermined
	 ...
	 */
	public PlayerObject(Vector2 initialPos, int size) {
		super(initialPos);
		players.add(this);
		ID = Math.random() * range;
		AddComponent(
	...
	/**
	 * Constructor for a player object that owns a weapon
	 * @param weaponName
	 ...
	 */
	public PlayerObject(String weaponName, int damage, int cost) {
		super(new Vector2(0, 0));
		players.add(this);
		ID = Math.random() * range;
		AddComponent(
