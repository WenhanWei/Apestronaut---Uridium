...
/**
 * The GameOverView is to be presented to the user if they successfully complete all of the levels.
 */
public class GameOverView extends PauseView {

    public JDialog gameOverMenu;

    /**
     * The GameOverView is a JDialog that is displayed above the game.
    ...
    public GameOverView() {
        ...
        JLabel gameCompleted = new PauseView.Label("CONGRATULATIONS!");
        JLabel gameCompleted2 = new PauseView.Label("YOU HAVE COMPLETED");
        ...
        exitToMenu.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                Engine.Instance.times_paused=0;
