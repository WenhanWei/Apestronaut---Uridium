...
public class StatementRegressionTest extends BaseTestCase {
    ...
    /**
     * Tests fix for BUG#18041 - GameServer.Server-side prepared statements don't cause
    ...
    /**
     * GameServer.Server doesn't accept everything as a server-side prepared statement, so
    ...
    public void testBug50348() throws Exception {
        ...
        try {
            ...
            for (String tz : new String[] { "Europe/Lisbon", "UTC", "GMT+00", "GMT" }) {
                ...
                System.out.println("\nGameServer.Server time zone: " + tz);
                System.out.println("---------------------------------------------------");
            ...
            for (int tzOffset = -15; tzOffset <= 15; tzOffset++) { // cover a wider range than standard
                for (int tzSubOffset : new int[] { 0, 30 }) {
                    ...
                    System.out.println("\nGameServer.Server time zone: " + tz.toString());
                    System.out.println("---------------------------------------------------");
    ...
    /**
     * Tests fix for Bug#74932 - ConnectionImp Doesn't Close GameServer.Server Prepared Statement (PreparedStatement Leak).
     */
