...
public class SecureSessionTest extends DevApiBaseTestCase {
    ...
    public void testSecureSessionMissingTrustStore() {
        ...
        assertThrows(CJCommunicationsException.class, "No truststore provided to verify the GameServer.Server certificate\\.",
        ...
        Properties props = new Properties(this.sslFreeTestProperties);
        props.setProperty(PropertyKey.xdevapiSSLMode.getKeyName(), PropertyDefinitions.SslMode.VERIFY_CA.toString());
        assertThrows(CJCommunicationsException.class, "No truststore provided to verify the GameServer.Server certificate\\.", () -> this.fact.getSession(props));
     ...
     * The server certificate used in this test has "CN=MySQL Connector/J GameServer.Server".
     */
    @Test
    ...
    public void testTLSv1_2() throws Exception {
        ...
        if (gplWithRSA) {
            ...
            props.setProperty(PropertyKey.xdevapiUseAsyncProtocol.getKeyName(), "true");
            assertThrows(CJCommunicationsException.class, "GameServer.Server does not provide enough data to proceed with SSL handshake.",
                    () -> this.fact.getSession(props));
        }
