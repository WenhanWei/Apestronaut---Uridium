...
public class SessionFailoverTest extends DevApiBaseTestCase {
    ...
    private class ConnectionsCounterFakeServer implements Callable<Void> {
        ...
        public Void call() {
            try {
                ...
                // GameServer.Server socket closed.
            }
            return null;
        }
    }
    ...
    public void testConnectionTimeout() throws Exception {
        ...
        // TS1_1 Create a session to a GameServer.Server using explicit "xdevapi.connect-timeout" overriding implicit "connectTimeout".
        ...
        // TS1_2 Create a session to a GameServer.Server using explicit "xdevapi.connect-timeout" overriding explicit "connectTimeout".
        ...
        // TS1_3 Create a session to a GameServer.Server using explicit "connectTimeout" overriding implicit "xdevapi.connect-timeout".
        ...
        // TS6_1 Create a session using the fail over functionality passing two different GameServer.Server addresses.
        // The GameServer.Server with the higher priority must be offline. The connection must succeed after connect-timeout milliseconds.
        ...
        // TS6_2 Create a session using the fail over functionality passing two different GameServer.Server addresses.
        ...
        // TS8_1 Create a session to a GameServer.Server using valid credentials passing the "connect-timeout" and set it to a valid value.
        ...
        // TS12_1 Create a session to a GameServer.Server giving a valid value for the "connect-timeout", and use invalid credentials.
