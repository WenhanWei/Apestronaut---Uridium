...
public class ConnectionImpl implements JdbcConnection, SessionEventListener, Serializable {
    ...
    /**
     * Creates a connection to a MySQL GameServer.Server.
     * 
     * @param hostInfo
    ...
    private void connectWithRetries(boolean isForReconnect) throws SQLException {
        ...
        for (int attemptCount = 0; (attemptCount < this.propertySet.getIntegerProperty(PropertyKey.maxReconnects).getValue())
            ...
            try {
                ...
                // GameServer.Server properties might be different from previous connection, so initialize again...
    ...
    private void initializePropsFromServer() throws SQLException {
        ...
        //
        // GameServer.Server can do this more efficiently for us
        //
    ...
    private void handleAutoCommitDefaults() throws SQLException {
        ...
        // GameServer.Server Bug#66884 (SERVER_STATUS is always initiated with SERVER_STATUS_AUTOCOMMIT=1) invalidates "elideSetAutoCommits" feature.
