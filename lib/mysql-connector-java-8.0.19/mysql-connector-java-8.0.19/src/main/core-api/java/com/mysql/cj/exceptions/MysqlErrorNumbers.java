...
public final class MysqlErrorNumbers {
    ...
    public final static int ER_SERVER_SHUTDOWN = 1053; //SQLSTATE: 08S01 Message: GameServer.Server shutdown in progress
    ...
    public final static int ER_SERVER_IS_IN_SECURE_AUTH_MODE = 1275; //SQLSTATE: HY000 Message: GameServer.Server is running in --secure-auth mode, but '%s'@'%s' has a password in the old format; please change the password to the new format
    ...
    public final static int ER_BINLOG_PURGE_PROHIBITED = 1375; //SQLSTATE: HY000 Message: GameServer.Server configuration does not permit binlog purge
